...
function section1Score() {
  ...
  for (let index = 0; index < 3; index++) {
    ...
    if (cform.querySelector('input[type="radio"]:checked')){
      if (cform.querySelector('input[type="radio"]:checked').value == sec1Ans[index]) {
        score += 40;
      }
  ...
  document.cookie = "section1Score=" + finalScore + "; expires=Tue, 20 Feb 2024 23:00:00 UTC";
...
function section2Score() {
  ...
  for (let index = 0; index < 5; index++) {
    ...
    if (cform.querySelector('input[type="radio"]:checked')){
      if (cform.querySelector('input[type="radio"]:checked').value == sec2Ans[index]) {
        score += 40;
      }
  ...
  var finalScore = parseInt(score - penality);
  finalScore = finalScore <= 0 ? 1 : finalScore;
  document.cookie = "section2Score=" + finalScore + "; expires=Tue, 20 Feb 2024 23:00:00 UTC";
...
function section3Score() {
  ...
  for (let index = 0; index < 5; index++) {
    ...
    if (cform.querySelector('input[type="radio"]:checked')){
      if (cform.querySelector('input[type="radio"]:checked').value == sec3Ans[index]) {
        score += 40;
      }
  ...
  var finalScore = parseInt(score - penality);
  finalScore = finalScore <= 0 ? 1 : finalScore;
  document.cookie = "section3Score=" + finalScore + "; expires=Tue, 20 Feb 2024 23:00:00 UTC";
  submitFinalScore();
}
...
setTimeout(() => {
  ...
  async function submitFinalScore() {
    ...
    try {
      ...
      alert("ERROR SUBMITTING, Don't Worry Your Score Is Saved Just Refresh Page To Submit Automatically");
    }
  }
